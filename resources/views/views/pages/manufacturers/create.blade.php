...
@section('header')
    <h1 class="page-title">New Manufacturer</h1>
...
@section('content')
    {{--<h2>Admins</h2>--}}
    <div class="panel">
        <form id="form-manufacturer-create" method="POST" action="{{ route('manufacturers.store') }}">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">Manufacturer Name<span class="required">*</span> </label>
                            <div class="col-md-9">
                                <input id="name" name="name" type="text"
                                       class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                       placeholder="Manufacturer Name" value="{{ old('name') }}"
                                       autocomplete="off">
...
<script>
    $(function() {
        ...
        $('#form-manufacturer-create').validate({
            rules: {
        ...
        $('#btn-reset').click(function() {
            ...
            $('#form-manufacturer-create').resetForm();
        });
