                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select id="role" name="role" data-plugin="select2"
                                    ...
                                    <option value="">-</option>
                                    <option value="{{ \App\Models\Admin::ROLE_ADMIN }}" @if(old('role') == \App\Models\Admin::ROLE_ADMIN) selected @endif>Admin</option>
                                    <option value="{{ \App\Models\Admin::ROLE_MANAGER }}" @if(old('role') == \App\Models\Admin::ROLE_MANAGER) selected @endif>Manager</option>
                                </select>
