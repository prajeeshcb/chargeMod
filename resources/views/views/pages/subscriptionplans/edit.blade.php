...
@section('content')
    {{--<h2>Admins</h2>--}}
    <div class="panel">
        <form id="form-subscription-plan-update" method="POST" action="{{ route('subscription-plans.update', $subscription_plan->id) }}">
            @csrf
            @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="name" name="name" type="text"
                                       ...
                                       placeholder="Name" value="{{ old('name',$subscription_plan->name) }}"
                                       autocomplete="off">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select id="interval" name="interval" data-plugin="select2"
                                    ...
                                    <option {{ old('interval',
                                    $subscription_plan->interval) == \App\Models\SubscriptionPlan::SUBSCRIPTION_PLAN_MONTHLY ? 'selected' : ''  }} value="0">Monthly</option>
                                    <option {{ old('interval',
                                    $subscription_plan->interval) == \App\Models\SubscriptionPlan::SUBSCRIPTION_PLAN_YEARLY ? 'selected' : ''  }} value="1">Yearly</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="interval_count" name="interval_count" type="text"
                                       ...
                                       placeholder="Interval Count" value="{{ old('interval_count',$subscription_plan->interval_count) }}"
                                       autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="amount" name="amount" type="text"
                                       ...
                                       placeholder="Amount" value="{{ old('amount',$subscription_plan->amount) }}"
                                       autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="quantity" name="quantity" type="text"
                                       ...
                                       placeholder="Quantity" value="{{ old('quantity',$subscription_plan->quantity) }}"
                                       autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="checkbox-custom checkbox-inline checkbox-primary checkbox-lg float-left">
                                    <input id="status" name="status" type="checkbox" value="1" @if(old('status', $subscription_plan->status)) checked @endif
...
<script>
    $(function() {
        ...
        $('#form-subscription-plan-update').validate({
            rules: {
        ...
        $('#btn-reset').click(function() {
            $('#form-subscription-plan-update').resetForm();
        });
