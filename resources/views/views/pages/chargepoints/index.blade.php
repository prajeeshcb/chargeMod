                ...
                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/CP/details/{{ $value->CP_ID }}">Show more...</a></td>
                            <td><a href="/CP/edit/{{ $value->CP_ID }}">Edit</a></td>
                            <td><a href="/CP/delete/{{ $value->CP_ID }}" onclick="return confirm('Are you sure you want to delete this CP')">Delete</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
