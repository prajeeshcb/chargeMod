...
@section('header')
    <h1 class="page-title">Digital Cards</h1>
    <div class="page-header-actions">
        <a class="btn btn-sm btn-primary btn-round" href="{{ route('digital-cards.create') }}">
            <i class="icon fa-plus" aria-hidden="true"></i>
            <span class="text hidden-sm-down">Create Digital Cards</span>
        </a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="card">
        <div class="card-body bg-grey-100">
            <form id="form-filter-digitalCard" class="form-inline mb-0">
        ...
        <div class="card-body">
            {!! $html->table(['id' => 'tbl-digital-card'], true) !!}
        </div>
    </div>
@endsection
...
<script>
    $(function() {
        ...
        $('#form-filter-digitalCard').submit(function(e) {
            e.preventDefault();
