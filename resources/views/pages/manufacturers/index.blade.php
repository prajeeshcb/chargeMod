...
@section('header')
    ...
    <div class="page-header-actions">
        <a class="btn btn-sm btn-primary btn-round" href="{{ route('manufacturers.create') }}">
            <i class="icon fa-plus" aria-hidden="true"></i>
            <span class="text hidden-sm-down">Create Manufacturer</span>
        </a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {!! $html->table(['id' => 'tbl-manufacturers'], true) !!}
        </div>
    </div>
@endsection
